...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Get Farmer balance after selling
        let finalFarmerBalance = await web3.eth.getBalance(originFarmerID)

        // Verify that the ownership changes to the distributor
        ...
        // Verify transfer of funds. Farmer balance after selling to disbributor should be incremented by productPrice
        assert.equal(Number(initialFarmerBalance) + Number(resultBufferTwo[4]), Number(finalFarmerBalance), 'Error: Invalid farmer balance after selling')
    })    
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // Distributor balance before selling
        let finallRetailerBalance = await web3.eth.getBalance(retailerID)
        ...
        // Verify transfer of funds. Retailer balance after selling to consumer should be incremented by productPrice
        assert.equal(Number(initialRetailerBalance) + Number(resultBufferTwo[4]), Number(finallRetailerBalance), 'Error: Invalid retailer balance after selling')
