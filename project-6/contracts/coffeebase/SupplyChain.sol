...
// Import access control for contract ownership
...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole, Ownable {
  ...
  // Define 'owner'
  // address owner; -> not used, inherits Ownable, and will set the owner in the constructor
  ...
  onlyFarmer()
  {
    ...
    items[_upc] = Item({sku: sku, upc: _upc, ownerID: _originFarmerID, originFarmerID: _originFarmerID, originFarmName: _originFarmName, originFarmInformation: _originFarmInformation, originFarmLatitude: _originFarmLatitude, originFarmLongitude: _originFarmLongitude, productID: (sku + _upc), productNotes: _productNotes, productPrice: 0, itemState: defaultState, distributorID: address(0), retailerID: address(0), consumerID: address(0)});
  ...
  // Define a function 'buyItem' that allows the disributor to mark an item 'Sold' when it buys it from the farmer
  ...
  function buyItem(uint _upc) public payable 
    ...
    checkValue(_upc)
    // Access control contract will allow distributors only
    onlyDistributor()
    {
